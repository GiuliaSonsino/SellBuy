...
class EliminaFotoActivity: AppCompatActivity()  {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        CoroutineScope(Dispatchers.IO).launch {
            ...
            storage.downloadUrl.addOnSuccessListener { url ->
                if (applicationContext != null) {
                    Glide.with(applicationContext).load(url).into(img1)
                }
            }
            if (immagini.size!! >= 2) {
                ...
                storage.downloadUrl.addOnSuccessListener { url ->
                    if (applicationContext != null) {
                        Glide.with(applicationContext).load(url).into(img2!!)
                    }
                }
            } else {
            ...
            if (immagini.size!! >= 3) {
                ...
                storage.downloadUrl.addOnSuccessListener { url ->
                    if (applicationContext != null) {
                        Glide.with(applicationContext).load(url).into(img3)
                    }
                }
            } else {
            ...
            if (immagini.size!! >= 4) {
                ...
                storage.downloadUrl.addOnSuccessListener { url ->
                    if (applicationContext != null) {
                        Glide.with(applicationContext).load(url).into(img4)
                    }
                }
            } else {
            ...
            if (immagini.size!! >= 5) {
                ...
                storage.downloadUrl.addOnSuccessListener { url ->
                    if (applicationContext != null) {
                        Glide.with(applicationContext).load(url).into(img5)
                    }
                }
            } else {
        ...
        btn1.setOnClickListener {
            ...
            GlobalScope.launch {
                FirebaseDbWrapper(applicationContext).deleteImmagineFromAnnuncio(applicationContext,codiceAnn!!,immaginiMod)
                FirebaseStorageWrapper(applicationContext).deleteImmagineFromStorage(applicationContext,nomeFoto)
            }
            Toast.makeText(
                applicationContext,
            ...
            val intent = Intent(this.applicationContext,AreaPersonaleActivity::class.java)
